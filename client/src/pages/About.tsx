...
export default function About() {
  const textContent = `المجلس (ممتد)، وياخد فترة طويلة، ونشرح فيه كتاب واحد فقط! أو كتابين بحد أقصى؟
...
المجلس هدفه إقحامك في التربية، مش بمعرفة الأدوات اللي تقدر تستخدمها وبس، إنما بإنك تشوف الأدوات دي ممثلة قدامك على الحقيقة مرة وإتنين وتلاتة، المجلس هدفه إن الأفكار اللي بنتكلم عنها تكون حتة منك، وأظن ده أثره واضح مع الأصدقاء في المجلس، مثال: إحنا مش بنتكلم عن الـ validation أو إقرار المشاعر، الناس بتشرب إقرار المشاعر وهي ماشية،
