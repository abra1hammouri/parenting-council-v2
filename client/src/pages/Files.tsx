      ...
      <main className="flex-1 pt-32 pb-20" style={{ backgroundColor: '#F8E6BC' }}>
        <div className="container">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {cards.map((card) => {
              // Cards 1, 3, 6: Show full image
              if (card.id === 1 || card.id === 3 || card.id === 6) {
                return (
                  <div
                    key={card.id}
                  ...
                  >
                    <div className="relative h-48 sm:h-64 lg:h-96 overflow-hidden bg-white flex items-center justify-center">
                      <img
                        src={card.image}
                        alt={card.title}
